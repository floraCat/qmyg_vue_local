<template>
	<div class="location-container" v-bind:class="{ open: true === locationSelecterIsOpen }">
	<!-- <div class="location-container" v-bind:class="{ open: true }"> -->
		<app-title title="城市" undefined v-on:goBack="goBack"></app-title>
	  <div class="scroller">
	  ...
	  <div class="body">
	    ...
	    <div class="header">当前: {{ current.city_name }}
	        ...
	        <div class="list-wrap">
	          <div class="hot-list">
	            ...
	            <div class="list-inner">
	              <div class="item">
	                <!-- <a @click="handleHotClick(location)">{{ location.city_name }}</a> -->
	                <a href="javascript:;">{{ location.city_name }}</a>
	              </div>
	            </div>
						</div>
	          ...
	          <div v-show="0 < lastCitys.length" class="hot-list">
	            ...
	            <div class="list-inner">
	              <div class="item" v-for="(item, index) in lastCitys" :key="index">
	                <a @click="handleHotClick(item)">{{ item.city_name }}</a>
	              </div>
	            </div>
	          </div>
